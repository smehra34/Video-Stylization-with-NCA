...
class AuxillaryLoss(torch.nn.Module):
    def __init__(self, args):
        super(AuxillaryLoss, self).__init__()
        self.args = args
    ...
    def forward(self, input_dict, return_summary=True):
        loss = 0.0
        target_image_list = input_dict['auxillary_image_list']
...
class MSELoss_(torch.nn.Module):
    def __init__(self, args):
    ...
    def forward(self, target_images, generated_images):
        ...
        return self.loss(target_images, generated_images)
