...
class Loss(torch.nn.Module):
    def __init__(self, args, nca_model):
        ...
        self.auxillary_loss_weight = getattr(args, "auxillary_loss_weight", 0.0)
    ...
    def _create_losses(self):
        ...
        if self.auxillary_loss_weight != 0:
            self.loss_mapper["auxillary"] = AuxillaryLoss(self.args)
            self.loss_weights["auxillary"] = self.auxillary_loss_weight
