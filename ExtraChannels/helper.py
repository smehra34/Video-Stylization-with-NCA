...
def save_video(video_name, target_vid_path, size_factor=1.0, step_n=8, steps_per_frame=1, is_style_image=False, nca_model=None, nca_size_x=256, nca_size_y=256, DEVICE='cuda'):
